...
- 対象プラン: **プレミアムプラン**（¥4,800/月・無料お試しなし・フェーズ2開放）
...
- **提供プラン**: プレミアムプラン（¥4,800/月）。**登録＝即時課金**（Pro・プレミアムとも無料お試しなし。AI原価が初月から発生するため特に重要）。¥980会員が50〜100人を超えた段階（フェーズ2）で開放。社内コード「ニャンニャンプラン」。
