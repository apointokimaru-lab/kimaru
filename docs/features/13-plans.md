...
> 料金: Pro ¥980/月・プレミアム ¥4,800/月。打ち合わせ（2026-06-03）で公開範囲 無料を 3→2ヶ月 に変更。アンケートは無料2問・Pro/プレミアム5問。**予約ページ保存数は 無料1/Pro2/プレミアム5（2026-06-18 決定27。旧 無料2/Pro5 から縮小）**。**ピンポイント日程調整は 2026-08-24 決定32（#338）で全プランへ開放**（リンク数 1/3/5・候補数 3/7/30・期限は無料のみ3日固定・押さえは Pro 以上）。上限は `_lib/plan-limits.js` の `PLAN_LIMITS` に集約。
